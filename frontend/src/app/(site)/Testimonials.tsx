  ...
  const testimonials: Testimonial[] = [
    {
      ...
      text: (
        <>
          I launched my startup in just a day and made my first $100 online! The
          setup was effortless,
          <span className="font-bold text-yellow-400">
            {" "}
            I was up and running faster{" "}
          </span>
    ...
    },
    {
      ...
      text: (
        <>
          No more overthinking or endless configurations{" "}
    ...
    },
    {
      ...
      text: (
        <>
          ...
          it&apos;s the ultimate launchpad for startups looking to move fast and
          break barriers.
        </>
      ),
      role: "Developer",
    ...
    },
    {
      ...
      text: (
        <>
          ...
          in record time. The support from the community is incredible!
        </>
      ),
      role: "Indie Hacker",
      avatar:
    ...
    },
    {
      ...
      text: (
        <>
          ...
          . I&apos;m now focusing on growing my user base instead of wrestling
          with code.
        </>
      ),
      role: "SaaS Founder",
